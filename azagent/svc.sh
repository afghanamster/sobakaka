...
SVC_NAME=`systemd-escape --path "vsts.agent.webdevthree99.docker.codespaces-4f5570.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (webdevthree99.docker.codespaces-4f5570)"
